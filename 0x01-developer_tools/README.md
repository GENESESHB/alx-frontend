...
<li><a href="https://intranet.alxswe.com/rltoken/I_IHgn0hsaB1kee6RgU1SQ" title="Inspect Network Activity - Chrome DevTools 101" target="_blank">Inspect Network Activity - Chrome DevTools 101</a></li>
</ul>
...
<div>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="11298" data-batch-id="90" data-toggle="modal" data-target="#task-11298-users-done-modal">
    Help
  </button>
...
<div>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="11301" data-batch-id="90" data-toggle="modal" data-target="#task-11301-users-done-modal">
    Help
  </button>
            ...
            <div class="modal-body">
                <div class="actions">
                    <center>
                        ...
                        <button name="button" type="submit" class="btn btn-primary correction_request_test_send" data-task-id="11302">Start a new test</button>
                        <button class="btn btn-default close-modal hidden" data-dismiss="modal" type="button">Close</button>
...
<div>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="11305" data-batch-id="90" data-toggle="modal" data-target="#task-11305-users-done-modal">
    Help
  </button>
...
<div>
  ...
  <div class="modal fade users-done-modal" id="task-11306-users-done-modal" data-task-id="11306" data-batch-id="90">
    ...
    <div data-role="task11307" data-position="13" id="task-num-12">
      <div class="panel panel-default task-card " id="task-11307">
  <span id="user_id" data-id="369701"></span>
  ...
  <div class="panel-body">
    ...
    <!-- Progress vs Score -->
      <div class="task_progress_score_bar" data-task-id="11307" data-correction-id="27622891">
        <div class="task_progress_bar" style="width: 100.0%">
          <div class="task_score_bar" style="width: 100.0%">
          </div>
        </div>
...
<p>Take a screenshot of the homepage, only emulation the CSS print version of the website.</p>
    ...
    <!-- Github information -->
      <div class="list-group-item">
        ...
        <ul>
          <li>GitHub repository: <code>alx-frontend</code></li>
            <li>Directory: <code>0x01-developer_tools</code></li>
            <li>File: <code>12-print_version.png</code></li>
        </ul>
      </div>
...
<div>
    <button class="student_task_done btn btn-default btn-sm no" data-task-id="11307">
      <span class="no"><i aria-hidden="true" class="fa-regular fa-square "></i></span>
      <span class="yes"><i aria-hidden="true" class="fa-regular fa-square-check "></i></span>
      <span class="pending"><i aria-hidden="true" class="fa-solid fa-spinner  fa-spin-pulse"></i></span>
      Done<span class="no pending">?</span><span class="yes">!</span>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="11307" data-batch-id="90" data-toggle="modal" data-target="#task-11307-users-done-modal">
    Help
  </button>
  <div class="modal fade users-done-modal" id="task-11307-users-done-modal" data-task-id="11307" data-batch-id="90">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            <h4 class="modal-title">Learners who are done with "12. Emulate the print version of the webpage"</h4>
        </div>
        <div class="modal-body">
            <div class="list-group">
            </div>
    ...
    <div data-role="task11308" data-position="14" id="task-num-13">
      <div class="panel panel-default task-card " id="task-11308">
  <span id="user_id" data-id="369701"></span>
...
<p>Select the Avatar image in the header and type <code>$0</code> in the console. Enter. </p>
    ...
    <!-- Github information -->
      <div class="list-group-item">
        ...
        <ul>
          <li>GitHub repository: <code>alx-frontend</code></li>
            <li>Directory: <code>0x01-developer_tools</code></li>
            <li>File: <code>13-logo_dollar0</code></li>
        </ul>
      </div>
...
<div>
    <button class="student_task_done btn btn-default btn-sm no" data-task-id="11308">
      <span class="no"><i aria-hidden="true" class="fa-regular fa-square "></i></span>
      <span class="yes"><i aria-hidden="true" class="fa-regular fa-square-check "></i></span>
      <span class="pending"><i aria-hidden="true" class="fa-solid fa-spinner  fa-spin-pulse"></i></span>
      Done<span class="no pending">?</span><span class="yes">!</span>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="11308" data-batch-id="90" data-toggle="modal" data-target="#task-11308-users-done-modal">
    Help
  </button>
  <div class="modal fade users-done-modal" id="task-11308-users-done-modal" data-task-id="11308" data-batch-id="90">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            <h4 class="modal-title">Learners who are done with "13. Using the console"</h4>
        </div>
        <div class="modal-body">
            <div class="list-group">
            </div>
      ...
      <button class="btn btn-default btn-sm check-your-task-11308-modal-button" data-task-id="11308" data-toggle="modal" data-target="#task-test-correction-11308-correction-modal" id="task-num-13-check-code-btn" data-gtm-custom-event-name="task_checker_modal" data-gtm-custom-event-options="{&quot;taskId&quot;:11308}">
          Check your code
      </button>
      <div class="modal fade task_correction_modal student_modal" id="task-test-correction-11308-correction-modal">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                <h4 class="modal-title">Correction of "13. Using the console"</h4>
            </div>
            <div class="modal-body">
                <div class="actions">
                    <center>
                        ...
                        <button name="button" type="submit" class="btn btn-primary correction_request_test_send" data-task-id="11308">Start a new test</button>
                        <button class="btn btn-default close-modal hidden" data-dismiss="modal" type="button">Close</button>
                ...
                <div class="help">
    <button data-task-id="11308">
        <i aria-hidden="true" class="fa-solid fa-circle-info "></i>
    </button>
    <div class="help-container" data-task-id="11308">
        <div class="check-line">
            <div class="check-inline requirement success">
                <i aria-hidden="true" class="fa-solid fa-circle-check "></i>
                Requirement success
    ...
    <div data-role="task11309" data-position="15" id="task-num-14">
      <div class="panel panel-default task-card " id="task-11309">
  <span id="user_id" data-id="369701"></span>
...
<p>Write in the console <code>console.log(document.title)</code>, what is returned?</p>
    ...
    <!-- Github information -->
      <div class="list-group-item">
        ...
        <ul>
          <li>GitHub repository: <code>alx-frontend</code></li>
            <li>Directory: <code>0x01-developer_tools</code></li>
            <li>File: <code>14-doc_title</code></li>
        </ul>
      </div>
...
<div>
    <button class="student_task_done btn btn-default btn-sm no" data-task-id="11309">
      <span class="no"><i aria-hidden="true" class="fa-regular fa-square "></i></span>
      <span class="yes"><i aria-hidden="true" class="fa-regular fa-square-check "></i></span>
      <span class="pending"><i aria-hidden="true" class="fa-solid fa-spinner  fa-spin-pulse"></i></span>
      Done<span class="no pending">?</span><span class="yes">!</span>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="11309" data-batch-id="90" data-toggle="modal" data-target="#task-11309-users-done-modal">
    Help
  </button>
  <div class="modal fade users-done-modal" id="task-11309-users-done-modal" data-task-id="11309" data-batch-id="90">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            <h4 class="modal-title">Learners who are done with "14. Write code in the console"</h4>
        </div>
        <div class="modal-body">
            <div class="list-group">
            </div>
      ...
      <button class="btn btn-default btn-sm check-your-task-11309-modal-button" data-task-id="11309" data-toggle="modal" data-target="#task-test-correction-11309-correction-modal" id="task-num-14-check-code-btn" data-gtm-custom-event-name="task_checker_modal" data-gtm-custom-event-options="{&quot;taskId&quot;:11309}">
          Check your code
      </button>
      <div class="modal fade task_correction_modal student_modal" id="task-test-correction-11309-correction-modal">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                <h4 class="modal-title">Correction of "14. Write code in the console"</h4>
            </div>
            <div class="modal-body">
                <div class="actions">
                    <center>
                        ...
                        <button name="button" type="submit" class="btn btn-primary correction_request_test_send" data-task-id="11309">Start a new test</button>
                        <button class="btn btn-default close-modal hidden" data-dismiss="modal" type="button">Close</button>
                ...
                <div class="help">
    <button data-task-id="11309">
        <i aria-hidden="true" class="fa-solid fa-circle-info "></i>
    </button>
    <div class="help-container" data-task-id="11309">
        <div class="check-line">
            <div class="check-inline requirement success">
                <i aria-hidden="true" class="fa-solid fa-circle-check "></i>
                Requirement success
    ...
    <div data-role="task11310" data-position="16" id="task-num-15">
      <div class="panel panel-default task-card " id="task-11310">
  <span id="user_id" data-id="369701"></span>
...
<p>Which front-end framework could we guess this page is using?</p>

<p>In your answer file only put the letter of the multiple choice answer from below:</p>

<ul>
<li>A. React JS</li>
<li>B. Material Design</li>
<li>C. Bootstrap</li>
<li>D. Angular JS</li>
</ul>
    ...
    <!-- Github information -->
      <div class="list-group-item">
        ...
        <ul>
          <li>GitHub repository: <code>alx-frontend</code></li>
            <li>Directory: <code>0x01-developer_tools</code></li>
            <li>File: <code>15-hbtn_framework</code></li>
        </ul>
      </div>
...
<div>
    <button class="student_task_done btn btn-default btn-sm no" data-task-id="11310">
      <span class="no"><i aria-hidden="true" class="fa-regular fa-square "></i></span>
      <span class="yes"><i aria-hidden="true" class="fa-regular fa-square-check "></i></span>
      <span class="pending"><i aria-hidden="true" class="fa-solid fa-spinner  fa-spin-pulse"></i></span>
      Done<span class="no pending">?</span><span class="yes">!</span>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="11310" data-batch-id="90" data-toggle="modal" data-target="#task-11310-users-done-modal">
    Help
  </button>
  <div class="modal fade users-done-modal" id="task-11310-users-done-modal" data-task-id="11310" data-batch-id="90">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            <h4 class="modal-title">Learners who are done with "15. Web framework"</h4>
        </div>
        <div class="modal-body">
            <div class="list-group">
            </div>
      ...
      <button class="btn btn-default btn-sm check-your-task-11310-modal-button" data-task-id="11310" data-toggle="modal" data-target="#task-test-correction-11310-correction-modal" id="task-num-15-check-code-btn" data-gtm-custom-event-name="task_checker_modal" data-gtm-custom-event-options="{&quot;taskId&quot;:11310}">
          Check your code
      </button>
      <div class="modal fade task_correction_modal student_modal" id="task-test-correction-11310-correction-modal">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                <h4 class="modal-title">Correction of "15. Web framework"</h4>
            </div>
            <div class="modal-body">
                <div class="actions">
                    <center>
                        ...
                        <button name="button" type="submit" class="btn btn-primary correction_request_test_send" data-task-id="11310">Start a new test</button>
                        <button class="btn btn-default close-modal hidden" data-dismiss="modal" type="button">Close</button>
                ...
                <div class="help">
    <button data-task-id="11310">
        <i aria-hidden="true" class="fa-solid fa-circle-info "></i>
    </button>
    <div class="help-container" data-task-id="11310">
        <div class="check-line">
            <div class="check-inline requirement success">
                <i aria-hidden="true" class="fa-solid fa-circle-check "></i>
                Requirement success
    ...
    <div data-role="task11311" data-position="17" id="task-num-16">
      <div class="panel panel-default task-card " id="task-11311">
  <span id="user_id" data-id="369701"></span>
  ...
  <div class="panel-body">
    ...
    <!-- Progress vs Score -->
      <div class="task_progress_score_bar" data-task-id="11311" data-correction-id="27622891">
        <div class="task_progress_bar" style="width: 100.0%">
          <div class="task_score_bar" style="width: 100.0%">
          </div>
        </div>
...
<p>What is the total weight of the page (with all the elements)?</p>
    ...
    <!-- Github information -->
      <div class="list-group-item">
        ...
        <ul>
          <li>GitHub repository: <code>alx-frontend</code></li>
            <li>Directory: <code>0x01-developer_tools</code></li>
            <li>File: <code>16-weight.png</code></li>
        </ul>
      </div>
...
<div>
    <button class="student_task_done btn btn-default btn-sm no" data-task-id="11311">
      <span class="no"><i aria-hidden="true" class="fa-regular fa-square "></i></span>
      <span class="yes"><i aria-hidden="true" class="fa-regular fa-square-check "></i></span>
      <span class="pending"><i aria-hidden="true" class="fa-solid fa-spinner  fa-spin-pulse"></i></span>
      Done<span class="no pending">?</span><span class="yes">!</span>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="11311" data-batch-id="90" data-toggle="modal" data-target="#task-11311-users-done-modal">
    Help
  </button>
  <div class="modal fade users-done-modal" id="task-11311-users-done-modal" data-task-id="11311" data-batch-id="90">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            <h4 class="modal-title">Learners who are done with "16. Homepage weight"</h4>
        </div>
        <div class="modal-body">
            <div class="list-group">
            </div>
    ...
    <div data-role="task11312" data-position="18" id="task-num-17">
      <div class="panel panel-default task-card " id="task-11312">
  <span id="user_id" data-id="369701"></span>
  ...
  <div class="panel-body">
    ...
    <!-- Progress vs Score -->
      <div class="task_progress_score_bar" data-task-id="11312" data-correction-id="27622891">
        <div class="task_progress_bar" style="width: 100.0%">
          <div class="task_score_bar" style="width: 100.0%">
          </div>
        </div>
...
<p>What is the number of requests done when accessing this page?</p>
    ...
    <!-- Github information -->
      <div class="list-group-item">
        ...
        <ul>
          <li>GitHub repository: <code>alx-frontend</code></li>
            <li>Directory: <code>0x01-developer_tools</code></li>
            <li>File: <code>17-requests.png</code></li>
        </ul>
      </div>
...
<div>
    <button class="student_task_done btn btn-default btn-sm no" data-task-id="11312">
      <span class="no"><i aria-hidden="true" class="fa-regular fa-square "></i></span>
      <span class="yes"><i aria-hidden="true" class="fa-regular fa-square-check "></i></span>
      <span class="pending"><i aria-hidden="true" class="fa-solid fa-spinner  fa-spin-pulse"></i></span>
      Done<span class="no pending">?</span><span class="yes">!</span>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="11312" data-batch-id="90" data-toggle="modal" data-target="#task-11312-users-done-modal">
    Help
  </button>
  <div class="modal fade users-done-modal" id="task-11312-users-done-modal" data-task-id="11312" data-batch-id="90">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            <h4 class="modal-title">Learners who are done with "17. Number of requests"</h4>
        </div>
        <div class="modal-body">
            <div class="list-group">
            </div>
    ...
    <div data-role="task11313" data-position="19" id="task-num-18">
      <div class="panel panel-default task-card " id="task-11313">
  <span id="user_id" data-id="369701"></span>
...
<p>How many CSS resources are loaded on this page?</p>
    ...
    <!-- Github information -->
      <div class="list-group-item">
        ...
        <ul>
          <li>GitHub repository: <code>alx-frontend</code></li>
            <li>Directory: <code>0x01-developer_tools</code></li>
            <li>File: <code>18-css_loaded</code></li>
        </ul>
      </div>
...
<div>
    <button class="student_task_done btn btn-default btn-sm no" data-task-id="11313">
      <span class="no"><i aria-hidden="true" class="fa-regular fa-square "></i></span>
      <span class="yes"><i aria-hidden="true" class="fa-regular fa-square-check "></i></span>
      <span class="pending"><i aria-hidden="true" class="fa-solid fa-spinner  fa-spin-pulse"></i></span>
      Done<span class="no pending">?</span><span class="yes">!</span>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="11313" data-batch-id="90" data-toggle="modal" data-target="#task-11313-users-done-modal">
    Help
  </button>
  <div class="modal fade users-done-modal" id="task-11313-users-done-modal" data-task-id="11313" data-batch-id="90">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            <h4 class="modal-title">Learners who are done with "18. Number of CSS files"</h4>
        </div>
        <div class="modal-body">
            <div class="list-group">
            </div>
      ...
      <button class="btn btn-default btn-sm check-your-task-11313-modal-button" data-task-id="11313" data-toggle="modal" data-target="#task-test-correction-11313-correction-modal" id="task-num-18-check-code-btn" data-gtm-custom-event-name="task_checker_modal" data-gtm-custom-event-options="{&quot;taskId&quot;:11313}">
          Check your code
      </button>
      <div class="modal fade task_correction_modal student_modal" id="task-test-correction-11313-correction-modal">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                <h4 class="modal-title">Correction of "18. Number of CSS files"</h4>
            </div>
            <div class="modal-body">
                <div class="actions">
                    <center>
                        ...
                        <button name="button" type="submit" class="btn btn-primary correction_request_test_send" data-task-id="11313">Start a new test</button>
                        <button class="btn btn-default close-modal hidden" data-dismiss="modal" type="button">Close</button>
                ...
                <div class="help">
    <button data-task-id="11313">
        <i aria-hidden="true" class="fa-solid fa-circle-info "></i>
    </button>
    <div class="help-container" data-task-id="11313">
        <div class="check-line">
            <div class="check-inline requirement success">
                <i aria-hidden="true" class="fa-solid fa-circle-check "></i>
                Requirement success
    ...
    <div data-role="task11314" data-position="20" id="task-num-19">
      <div class="panel panel-default task-card " id="task-11314">
  <span id="user_id" data-id="369701"></span>
...
<p>How many image resources are loaded on this page?</p>
    ...
    <!-- Github information -->
      <div class="list-group-item">
        ...
        <ul>
          <li>GitHub repository: <code>alx-frontend</code></li>
            <li>Directory: <code>0x01-developer_tools</code></li>
            <li>File: <code>19-images_loaded</code></li>
        </ul>
      </div>
...
<div>
    <button class="student_task_done btn btn-default btn-sm no" data-task-id="11314">
      <span class="no"><i aria-hidden="true" class="fa-regular fa-square "></i></span>
      <span class="yes"><i aria-hidden="true" class="fa-regular fa-square-check "></i></span>
      <span class="pending"><i aria-hidden="true" class="fa-solid fa-spinner  fa-spin-pulse"></i></span>
      Done<span class="no pending">?</span><span class="yes">!</span>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="11314" data-batch-id="90" data-toggle="modal" data-target="#task-11314-users-done-modal">
    Help
  </button>
  <div class="modal fade users-done-modal" id="task-11314-users-done-modal" data-task-id="11314" data-batch-id="90">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            <h4 class="modal-title">Learners who are done with "19. Number of images"</h4>
        </div>
        <div class="modal-body">
            <div class="list-group">
            </div>
      ...
      <button class="btn btn-default btn-sm check-your-task-11314-modal-button" data-task-id="11314" data-toggle="modal" data-target="#task-test-correction-11314-correction-modal" id="task-num-19-check-code-btn" data-gtm-custom-event-name="task_checker_modal" data-gtm-custom-event-options="{&quot;taskId&quot;:11314}">
          Check your code
      </button>
      <div class="modal fade task_correction_modal student_modal" id="task-test-correction-11314-correction-modal">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                <h4 class="modal-title">Correction of "19. Number of images"</h4>
            </div>
            <div class="modal-body">
                <div class="actions">
                    <center>
                        ...
                        <button name="button" type="submit" class="btn btn-primary correction_request_test_send" data-task-id="11314">Start a new test</button>
                        <button class="btn btn-default close-modal hidden" data-dismiss="modal" type="button">Close</button>
                ...
                <div class="help">
    <button data-task-id="11314">
        <i aria-hidden="true" class="fa-solid fa-circle-info "></i>
    </button>
    <div class="help-container" data-task-id="11314">
        <div class="check-line">
            <div class="check-inline requirement success">
                <i aria-hidden="true" class="fa-solid fa-circle-check "></i>
                Requirement success
    ...
    <div data-role="task11315" data-position="21" id="task-num-20">
      <div class="panel panel-default task-card " id="task-11315">
  <span id="user_id" data-id="369701"></span>
...
<p>What is the <code>type</code> value of the favicon image?</p>
    ...
    <!-- Github information -->
      <div class="list-group-item">
        ...
        <ul>
          <li>GitHub repository: <code>alx-frontend</code></li>
            <li>Directory: <code>0x01-developer_tools</code></li>
            <li>File: <code>20-favicon_type</code></li>
        </ul>
      </div>
...
<div>
    <button class="student_task_done btn btn-default btn-sm no" data-task-id="11315">
      <span class="no"><i aria-hidden="true" class="fa-regular fa-square "></i></span>
      <span class="yes"><i aria-hidden="true" class="fa-regular fa-square-check "></i></span>
      <span class="pending"><i aria-hidden="true" class="fa-solid fa-spinner  fa-spin-pulse"></i></span>
      Done<span class="no pending">?</span><span class="yes">!</span>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="11315" data-batch-id="90" data-toggle="modal" data-target="#task-11315-users-done-modal">
    Help
  </button>
  <div class="modal fade users-done-modal" id="task-11315-users-done-modal" data-task-id="11315" data-batch-id="90">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            <h4 class="modal-title">Learners who are done with "20. Favicon image type"</h4>
        </div>
        <div class="modal-body">
            <div class="list-group">
            </div>
      ...
      <button class="btn btn-default btn-sm check-your-task-11315-modal-button" data-task-id="11315" data-toggle="modal" data-target="#task-test-correction-11315-correction-modal" id="task-num-20-check-code-btn" data-gtm-custom-event-name="task_checker_modal" data-gtm-custom-event-options="{&quot;taskId&quot;:11315}">
          Check your code
      </button>
      <div class="modal fade task_correction_modal student_modal" id="task-test-correction-11315-correction-modal">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                <h4 class="modal-title">Correction of "20. Favicon image type"</h4>
            </div>
            <div class="modal-body">
                <div class="actions">
                    <center>
                        ...
                        <button name="button" type="submit" class="btn btn-primary correction_request_test_send" data-task-id="11315">Start a new test</button>
                        <button class="btn btn-default close-modal hidden" data-dismiss="modal" type="button">Close</button>
                ...
                <div class="help">
    <button data-task-id="11315">
        <i aria-hidden="true" class="fa-solid fa-circle-info "></i>
    </button>
    <div class="help-container" data-task-id="11315">
        <div class="check-line">
            <div class="check-inline requirement success">
                <i aria-hidden="true" class="fa-solid fa-circle-check "></i>
                Requirement success
    ...
    <div data-role="task11316" data-position="22" id="task-num-21">
      <div class="panel panel-default task-card " id="task-11316">
  <span id="user_id" data-id="369701"></span>
...
<p>The website uses a font library for their icons, which one is it?</p>
    ...
    <!-- Github information -->
      <div class="list-group-item">
        ...
        <ul>
          <li>GitHub repository: <code>alx-frontend</code></li>
            <li>Directory: <code>0x01-developer_tools</code></li>
            <li>File: <code>21-hbtn_font_lib</code></li>
        </ul>
      </div>
...
<div>
    <button class="student_task_done btn btn-default btn-sm no" data-task-id="11316">
      <span class="no"><i aria-hidden="true" class="fa-regular fa-square "></i></span>
      <span class="yes"><i aria-hidden="true" class="fa-regular fa-square-check "></i></span>
      <span class="pending"><i aria-hidden="true" class="fa-solid fa-spinner  fa-spin-pulse"></i></span>
      Done<span class="no pending">?</span><span class="yes">!</span>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="11316" data-batch-id="90" data-toggle="modal" data-target="#task-11316-users-done-modal">
    Help
  </button>
  <div class="modal fade users-done-modal" id="task-11316-users-done-modal" data-task-id="11316" data-batch-id="90">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            <h4 class="modal-title">Learners who are done with "21. Font library"</h4>
        </div>
        <div class="modal-body">
            <div class="list-group">
            </div>
      ...
      <button class="btn btn-default btn-sm check-your-task-11316-modal-button" data-task-id="11316" data-toggle="modal" data-target="#task-test-correction-11316-correction-modal" id="task-num-21-check-code-btn" data-gtm-custom-event-name="task_checker_modal" data-gtm-custom-event-options="{&quot;taskId&quot;:11316}">
          Check your code
      </button>
      <div class="modal fade task_correction_modal student_modal" id="task-test-correction-11316-correction-modal">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                <h4 class="modal-title">Correction of "21. Font library"</h4>
            </div>
            <div class="modal-body">
                <div class="actions">
                    <center>
                        ...
                        <button name="button" type="submit" class="btn btn-primary correction_request_test_send" data-task-id="11316">Start a new test</button>
                        <button class="btn btn-default close-modal hidden" data-dismiss="modal" type="button">Close</button>
                ...
                <div class="help">
    <button data-task-id="11316">
        <i aria-hidden="true" class="fa-solid fa-circle-info "></i>
    </button>
    <div class="help-container" data-task-id="11316">
        <div class="check-line">
            <div class="check-inline requirement success">
                <i aria-hidden="true" class="fa-solid fa-circle-check "></i>
                Requirement success
    ...
    <div data-role="task11317" data-position="23" id="task-num-22">
      <div class="panel panel-default task-card " id="task-11317">
  <span id="user_id" data-id="369701"></span>
...
<p>What is the name of the resource that generates 1 XHR calls? </p>
    ...
    <!-- Github information -->
      <div class="list-group-item">
        ...
        <ul>
          <li>GitHub repository: <code>alx-frontend</code></li>
            <li>Directory: <code>0x01-developer_tools</code></li>
            <li>File: <code>22-xhr_calls</code></li>
        </ul>
      </div>
...
<div>
    <button class="student_task_done btn btn-default btn-sm no" data-task-id="11317">
      <span class="no"><i aria-hidden="true" class="fa-regular fa-square "></i></span>
      <span class="yes"><i aria-hidden="true" class="fa-regular fa-square-check "></i></span>
      <span class="pending"><i aria-hidden="true" class="fa-solid fa-spinner  fa-spin-pulse"></i></span>
      Done<span class="no pending">?</span><span class="yes">!</span>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="11317" data-batch-id="90" data-toggle="modal" data-target="#task-11317-users-done-modal">
    Help
  </button>
  <div class="modal fade users-done-modal" id="task-11317-users-done-modal" data-task-id="11317" data-batch-id="90">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            <h4 class="modal-title">Learners who are done with "22. XHR calls"</h4>
        </div>
        <div class="modal-body">
            <div class="list-group">
            </div>
      ...
      <button class="btn btn-default btn-sm check-your-task-11317-modal-button" data-task-id="11317" data-toggle="modal" data-target="#task-test-correction-11317-correction-modal" id="task-num-22-check-code-btn" data-gtm-custom-event-name="task_checker_modal" data-gtm-custom-event-options="{&quot;taskId&quot;:11317}">
          Check your code
      </button>
      <div class="modal fade task_correction_modal student_modal" id="task-test-correction-11317-correction-modal">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                <h4 class="modal-title">Correction of "22. XHR calls"</h4>
            </div>
            <div class="modal-body">
                <div class="actions">
                    <center>
                        ...
                        <button name="button" type="submit" class="btn btn-primary correction_request_test_send" data-task-id="11317">Start a new test</button>
                        <button class="btn btn-default close-modal hidden" data-dismiss="modal" type="button">Close</button>
                ...
                <div class="help">
    <button data-task-id="11317">
        <i aria-hidden="true" class="fa-solid fa-circle-info "></i>
    </button>
    <div class="help-container" data-task-id="11317">
        <div class="check-line">
            <div class="check-inline requirement success">
                <i aria-hidden="true" class="fa-solid fa-circle-check "></i>
                Requirement success
    ...
    <div data-role="task11318" data-position="24" id="task-num-23">
      <div class="panel panel-default task-card " id="task-11318">
  <span id="user_id" data-id="369701"></span>
  ...
  <div class="panel-body">
    ...
    <!-- Progress vs Score -->
      <div class="task_progress_score_bar" data-task-id="11318" data-correction-id="27622891">
        <div class="task_progress_bar" style="width: 100.0%">
          <div class="task_score_bar" style="width: 100.0%">
          </div>
        </div>
...
<p>What is the notation for <code>Performance</code> (for desktop mode and no throttling - also called Lighthouse)?</p>
    ...
    <!-- Github information -->
      <div class="list-group-item">
        ...
        <ul>
          <li>GitHub repository: <code>alx-frontend</code></li>
            <li>Directory: <code>0x01-developer_tools</code></li>
            <li>File: <code>23-performance_audit.png</code></li>
        </ul>
      </div>
...
<div>
    <button class="student_task_done btn btn-default btn-sm no" data-task-id="11318">
      <span class="no"><i aria-hidden="true" class="fa-regular fa-square "></i></span>
      <span class="yes"><i aria-hidden="true" class="fa-regular fa-square-check "></i></span>
      <span class="pending"><i aria-hidden="true" class="fa-solid fa-spinner  fa-spin-pulse"></i></span>
      Done<span class="no pending">?</span><span class="yes">!</span>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="11318" data-batch-id="90" data-toggle="modal" data-target="#task-11318-users-done-modal">
    Help
  </button>
  <div class="modal fade users-done-modal" id="task-11318-users-done-modal" data-task-id="11318" data-batch-id="90">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            <h4 class="modal-title">Learners who are done with "23. Audits panel"</h4>
        </div>
        <div class="modal-body">
            <div class="list-group">
            </div>
    ...
    <div data-role="task11319" data-position="25" id="task-num-24">
      <div class="panel panel-default task-card " id="task-11319">
  <span id="user_id" data-id="369701"></span>
  ...
  <div class="panel-body">
    ...
    <!-- Progress vs Score -->
      <div class="task_progress_score_bar" data-task-id="11319" data-correction-id="27622891">
        <div class="task_progress_bar" style="width: 100.0%">
          <div class="task_score_bar" style="width: 100.0%">
          </div>
        </div>
...
<p>How many static assets need a better cache policy?</p>
    ...
    <!-- Github information -->
      <div class="list-group-item">
        ...
        <ul>
          <li>GitHub repository: <code>alx-frontend</code></li>
            <li>Directory: <code>0x01-developer_tools</code></li>
            <li>File: <code>24-static_assets_audit.png</code></li>
        </ul>
      </div>
...
<div>
    <button class="student_task_done btn btn-default btn-sm no" data-task-id="11319">
      <span class="no"><i aria-hidden="true" class="fa-regular fa-square "></i></span>
      <span class="yes"><i aria-hidden="true" class="fa-regular fa-square-check "></i></span>
      <span class="pending"><i aria-hidden="true" class="fa-solid fa-spinner  fa-spin-pulse"></i></span>
      Done<span class="no pending">?</span><span class="yes">!</span>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="11319" data-batch-id="90" data-toggle="modal" data-target="#task-11319-users-done-modal">
    Help
  </button>
  <div class="modal fade users-done-modal" id="task-11319-users-done-modal" data-task-id="11319" data-batch-id="90">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            <h4 class="modal-title">Learners who are done with "24. Static assets"</h4>
        </div>
        <div class="modal-body">
            <div class="list-group">
            </div>
    ...
    <div data-role="task11320" data-position="26" id="task-num-25">
      <div class="panel panel-default task-card " id="task-11320">
  <span id="user_id" data-id="369701"></span>
...
<p>When you run an accessibility audit, what is the contrast issue?</p>

<p>In your answer file only put the letter of the multiple choice answer from below:</p>

<ul>
<li>A. Image elements do not have [alt] attributes</li>
<li>B. Links do not have a discernible name</li>
<li>C. Background and foreground colors do not have a sufficient contrast ratio.</li>
</ul>
    ...
    <!-- Github information -->
      <div class="list-group-item">
        ...
        <ul>
          <li>GitHub repository: <code>alx-frontend</code></li>
            <li>Directory: <code>0x01-developer_tools</code></li>
            <li>File: <code>25-contrast_issue</code></li>
        </ul>
      </div>
...
<div>
    <button class="student_task_done btn btn-default btn-sm no" data-task-id="11320">
      <span class="no"><i aria-hidden="true" class="fa-regular fa-square "></i></span>
      <span class="yes"><i aria-hidden="true" class="fa-regular fa-square-check "></i></span>
      <span class="pending"><i aria-hidden="true" class="fa-solid fa-spinner  fa-spin-pulse"></i></span>
      Done<span class="no pending">?</span><span class="yes">!</span>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="11320" data-batch-id="90" data-toggle="modal" data-target="#task-11320-users-done-modal">
    Help
  </button>
  <div class="modal fade users-done-modal" id="task-11320-users-done-modal" data-task-id="11320" data-batch-id="90">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            <h4 class="modal-title">Learners who are done with "25. Accessibility"</h4>
        </div>
        <div class="modal-body">
            <div class="list-group">
            </div>
      ...
      <button class="btn btn-default btn-sm check-your-task-11320-modal-button" data-task-id="11320" data-toggle="modal" data-target="#task-test-correction-11320-correction-modal" id="task-num-25-check-code-btn" data-gtm-custom-event-name="task_checker_modal" data-gtm-custom-event-options="{&quot;taskId&quot;:11320}">
          Check your code
      </button>
      <div class="modal fade task_correction_modal student_modal" id="task-test-correction-11320-correction-modal">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                <h4 class="modal-title">Correction of "25. Accessibility"</h4>
            </div>
            <div class="modal-body">
                <div class="actions">
                    <center>
                        ...
                        <button name="button" type="submit" class="btn btn-primary correction_request_test_send" data-task-id="11320">Start a new test</button>
                        <button class="btn btn-default close-modal hidden" data-dismiss="modal" type="button">Close</button>
                ...
                <div class="help">
    <button data-task-id="11320">
        <i aria-hidden="true" class="fa-solid fa-circle-info "></i>
    </button>
    <div class="help-container" data-task-id="11320">
        <div class="check-line">
            <div class="check-inline requirement success">
                <i aria-hidden="true" class="fa-solid fa-circle-check "></i>
                Requirement success
    ...
    <div data-role="task11321" data-position="27" id="task-num-26">
      <div class="panel panel-default task-card " id="task-11321">
  <span id="user_id" data-id="369701"></span>
...
<p>Which classes are on the images that have no <code>alt</code> attribute?</p>

<p>Your answer file must contains all classes, example: <code>.my_class.my_second</code> if 2 classes</p>
    ...
    <!-- Github information -->
      <div class="list-group-item">
        ...
        <ul>
          <li>GitHub repository: <code>alx-frontend</code></li>
            <li>Directory: <code>0x01-developer_tools</code></li>
            <li>File: <code>26-no_alt</code></li>
        </ul>
      </div>
...
<div>
    <button class="student_task_done btn btn-default btn-sm no" data-task-id="11321">
      <span class="no"><i aria-hidden="true" class="fa-regular fa-square "></i></span>
      <span class="yes"><i aria-hidden="true" class="fa-regular fa-square-check "></i></span>
      <span class="pending"><i aria-hidden="true" class="fa-solid fa-spinner  fa-spin-pulse"></i></span>
      Done<span class="no pending">?</span><span class="yes">!</span>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="11321" data-batch-id="90" data-toggle="modal" data-target="#task-11321-users-done-modal">
    Help
  </button>
  <div class="modal fade users-done-modal" id="task-11321-users-done-modal" data-task-id="11321" data-batch-id="90">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            <h4 class="modal-title">Learners who are done with "26. No alt"</h4>
        </div>
        <div class="modal-body">
            <div class="list-group">
            </div>
      ...
      <button class="btn btn-default btn-sm check-your-task-11321-modal-button" data-task-id="11321" data-toggle="modal" data-target="#task-test-correction-11321-correction-modal" id="task-num-26-check-code-btn" data-gtm-custom-event-name="task_checker_modal" data-gtm-custom-event-options="{&quot;taskId&quot;:11321}">
          Check your code
      </button>
      <div class="modal fade task_correction_modal student_modal" id="task-test-correction-11321-correction-modal">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                <h4 class="modal-title">Correction of "26. No alt"</h4>
            </div>
            <div class="modal-body">
                <div class="actions">
                    <center>
                        ...
                        <button name="button" type="submit" class="btn btn-primary correction_request_test_send" data-task-id="11321">Start a new test</button>
                        <button class="btn btn-default close-modal hidden" data-dismiss="modal" type="button">Close</button>
                ...
                <div class="help">
    <button data-task-id="11321">
        <i aria-hidden="true" class="fa-solid fa-circle-info "></i>
    </button>
    <div class="help-container" data-task-id="11321">
        <div class="check-line">
            <div class="check-inline requirement success">
                <i aria-hidden="true" class="fa-solid fa-circle-check "></i>
                Requirement success
    ...
    <div data-role="task11322" data-position="28" id="task-num-27">
      <div class="panel panel-default task-card " id="task-11322">
  <span id="user_id" data-id="369701"></span>
...
<p>Which attribute is missing on all the links with the target <code>_blank</code>?</p>

<p>In your answer file only put the letter of the multiple choice answer from below:</p>

<ul>
<li>A. <code>rel="noopener"</code></li>
<li>B. <code>rel="noreferrer"</code></li>
<li>C. A and B</li>
<li>D. <code>rel = "nofollow"</code></li>
</ul>
    ...
    <!-- Github information -->
      <div class="list-group-item">
        ...
        <ul>
          <li>GitHub repository: <code>alx-frontend</code></li>
            <li>Directory: <code>0x01-developer_tools</code></li>
            <li>File: <code>27-missing_attr</code></li>
        </ul>
      </div>
...
<div>
    <button class="student_task_done btn btn-default btn-sm no" data-task-id="11322">
      <span class="no"><i aria-hidden="true" class="fa-regular fa-square "></i></span>
      <span class="yes"><i aria-hidden="true" class="fa-regular fa-square-check "></i></span>
      <span class="pending"><i aria-hidden="true" class="fa-solid fa-spinner  fa-spin-pulse"></i></span>
      Done<span class="no pending">?</span><span class="yes">!</span>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="11322" data-batch-id="90" data-toggle="modal" data-target="#task-11322-users-done-modal">
    Help
  </button>
  <div class="modal fade users-done-modal" id="task-11322-users-done-modal" data-task-id="11322" data-batch-id="90">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            <h4 class="modal-title">Learners who are done with "27. Best practices"</h4>
        </div>
        <div class="modal-body">
            <div class="list-group">
            </div>
      ...
      <button class="btn btn-default btn-sm check-your-task-11322-modal-button" data-task-id="11322" data-toggle="modal" data-target="#task-test-correction-11322-correction-modal" id="task-num-27-check-code-btn" data-gtm-custom-event-name="task_checker_modal" data-gtm-custom-event-options="{&quot;taskId&quot;:11322}">
          Check your code
      </button>
      <div class="modal fade task_correction_modal student_modal" id="task-test-correction-11322-correction-modal">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                <h4 class="modal-title">Correction of "27. Best practices"</h4>
            </div>
            <div class="modal-body">
                <div class="actions">
                    <center>
                        ...
                        <button name="button" type="submit" class="btn btn-primary correction_request_test_send" data-task-id="11322">Start a new test</button>
                        <button class="btn btn-default close-modal hidden" data-dismiss="modal" type="button">Close</button>
                ...
                <div class="help">
    <button data-task-id="11322">
        <i aria-hidden="true" class="fa-solid fa-circle-info "></i>
    </button>
    <div class="help-container" data-task-id="11322">
        <div class="check-line">
            <div class="check-inline requirement success">
                <i aria-hidden="true" class="fa-solid fa-circle-check "></i>
                Requirement success
    ...
    <div data-role="task11323" data-position="29" id="task-num-28">
      <div class="panel panel-default task-card " id="task-11323">
  <span id="user_id" data-id="369701"></span>
  ...
  <div class="panel-body">
    ...
    <!-- Progress vs Score -->
      <div class="task_progress_score_bar" data-task-id="11323" data-correction-id="27622891">
        <div class="task_progress_bar" style="width: 100.0%">
          <div class="task_score_bar" style="width: 100.0%">
          </div>
        </div>
...
<p>Which <code>&lt;a&gt;</code> links don’t have enough text description?</p>
    ...
    <!-- Github information -->
      <div class="list-group-item">
        ...
        <ul>
          <li>GitHub repository: <code>alx-frontend</code></li>
            <li>Directory: <code>0x01-developer_tools</code></li>
            <li>File: <code>28-unclear_desc.png</code></li>
        </ul>
      </div>
...
<div>
    <button class="student_task_done btn btn-default btn-sm no" data-task-id="11323">
      <span class="no"><i aria-hidden="true" class="fa-regular fa-square "></i></span>
      <span class="yes"><i aria-hidden="true" class="fa-regular fa-square-check "></i></span>
      <span class="pending"><i aria-hidden="true" class="fa-solid fa-spinner  fa-spin-pulse"></i></span>
      Done<span class="no pending">?</span><span class="yes">!</span>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="11323" data-batch-id="90" data-toggle="modal" data-target="#task-11323-users-done-modal">
    Help
  </button>
  <div class="modal fade users-done-modal" id="task-11323-users-done-modal" data-task-id="11323" data-batch-id="90">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            <h4 class="modal-title">Learners who are done with "28. SEO"</h4>
        </div>
        <div class="modal-body">
            <div class="list-group">
            </div>
    ...
    <div data-role="task11324" data-position="30" id="task-num-29">
      <div class="panel panel-default task-card " id="task-11324">
  <span id="user_id" data-id="369701"></span>
  ...
  <div class="panel-body">
    ...
    <!-- Progress vs Score -->
      <div class="task_progress_score_bar" data-task-id="11324" data-correction-id="27622891">
        <div class="task_progress_bar" style="width: 100.0%">
          <div class="task_score_bar" style="width: 100.0%">
          </div>
        </div>
...
<p>The <code>sources</code> panel allow you to edit files, add breakpoints to analyse your JavaScript code and create snippets.</p>

<ul>
<li>Create a new snippet called <code>allcolors.js</code></li>
<li>Copy-paste the code on <a href="https://intranet.alxswe.com/rltoken/OT7WVbPhXDu_o9oL54pQ9g" title="that page" target="_blank">that page</a></li>
<li>Run the code</li>
<li>Take a screenshot of the result in your console</li>
</ul>
    ...
    <!-- Github information -->
      <div class="list-group-item">
        ...
        <ul>
          <li>GitHub repository: <code>alx-frontend</code></li>
            <li>Directory: <code>0x01-developer_tools</code></li>
            <li>File: <code>29-how_many_colors.png</code></li>
        </ul>
      </div>
...
<div>
    <button class="student_task_done btn btn-default btn-sm no" data-task-id="11324">
      <span class="no"><i aria-hidden="true" class="fa-regular fa-square "></i></span>
      <span class="yes"><i aria-hidden="true" class="fa-regular fa-square-check "></i></span>
      <span class="pending"><i aria-hidden="true" class="fa-solid fa-spinner  fa-spin-pulse"></i></span>
      Done<span class="no pending">?</span><span class="yes">!</span>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="11324" data-batch-id="90" data-toggle="modal" data-target="#task-11324-users-done-modal">
    Help
  </button>
  <div class="modal fade users-done-modal" id="task-11324-users-done-modal" data-task-id="11324" data-batch-id="90">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            <h4 class="modal-title">Learners who are done with "29. Sources"</h4>
        </div>
        <div class="modal-body">
            <div class="list-group">
            </div>
    ...
    <div data-role="task11325" data-position="31" id="task-num-30">
      <div class="panel panel-default task-card " id="task-11325">
  <span id="user_id" data-id="369701"></span>
  ...
  <div class="panel-body">
    ...
    <!-- Progress vs Score -->
      <div class="task_progress_score_bar" data-task-id="11325" data-correction-id="27622891">
        <div class="task_progress_bar" style="width: 100.0%">
          <div class="task_score_bar" style="width: 100.0%">
          </div>
        </div>
    ...
    <!-- Github information -->
      <div class="list-group-item">
        ...
        <ul>
          <li>GitHub repository: <code>alx-frontend</code></li>
            <li>Directory: <code>0x01-developer_tools</code></li>
            <li>File: <code>30-no_css.png</code></li>
        </ul>
      </div>
...
<div>
    <button class="student_task_done btn btn-default btn-sm no" data-task-id="11325">
      <span class="no"><i aria-hidden="true" class="fa-regular fa-square "></i></span>
      <span class="yes"><i aria-hidden="true" class="fa-regular fa-square-check "></i></span>
      <span class="pending"><i aria-hidden="true" class="fa-solid fa-spinner  fa-spin-pulse"></i></span>
      Done<span class="no pending">?</span><span class="yes">!</span>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="11325" data-batch-id="90" data-toggle="modal" data-target="#task-11325-users-done-modal">
    Help
  </button>
  <div class="modal fade users-done-modal" id="task-11325-users-done-modal" data-task-id="11325" data-batch-id="90">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            <h4 class="modal-title">Learners who are done with "30. Block CSS files"</h4>
        </div>
        <div class="modal-body">
            <div class="list-group">
            </div>
    ...
    <div data-role="task11326" data-position="32" id="task-num-31">
      <div class="panel panel-default task-card " id="task-11326">
  <span id="user_id" data-id="369701"></span>
...
<p>The <code>application</code> panel gives you access to the storage (cookies, sessions, cache…) and some other options as Services Workers and more recently, notifications.</p>

<p>What is the only key present in the session storage for this page?</p>
    ...
    <!-- Github information -->
      <div class="list-group-item">
        ...
        <ul>
          <li>GitHub repository: <code>alx-frontend</code></li>
            <li>Directory: <code>0x01-developer_tools</code></li>
            <li>File: <code>31-session_storage_key</code></li>
        </ul>
      </div>
...
<div>
    <button class="student_task_done btn btn-default btn-sm no" data-task-id="11326">
      <span class="no"><i aria-hidden="true" class="fa-regular fa-square "></i></span>
      <span class="yes"><i aria-hidden="true" class="fa-regular fa-square-check "></i></span>
      <span class="pending"><i aria-hidden="true" class="fa-solid fa-spinner  fa-spin-pulse"></i></span>
      Done<span class="no pending">?</span><span class="yes">!</span>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="11326" data-batch-id="90" data-toggle="modal" data-target="#task-11326-users-done-modal">
    Help
  </button>
  <div class="modal fade users-done-modal" id="task-11326-users-done-modal" data-task-id="11326" data-batch-id="90">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            <h4 class="modal-title">Learners who are done with "31. Application panel"</h4>
        </div>
        <div class="modal-body">
            <div class="list-group">
            </div>
      ...
      <button class="btn btn-default btn-sm check-your-task-11326-modal-button" data-task-id="11326" data-toggle="modal" data-target="#task-test-correction-11326-correction-modal" id="task-num-31-check-code-btn" data-gtm-custom-event-name="task_checker_modal" data-gtm-custom-event-options="{&quot;taskId&quot;:11326}">
          Check your code
      </button>
      <div class="modal fade task_correction_modal student_modal" id="task-test-correction-11326-correction-modal">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                <h4 class="modal-title">Correction of "31. Application panel"</h4>
            </div>
            <div class="modal-body">
                <div class="actions">
                    <center>
                        ...
                        <button name="button" type="submit" class="btn btn-primary correction_request_test_send" data-task-id="11326">Start a new test</button>
                        <button class="btn btn-default close-modal hidden" data-dismiss="modal" type="button">Close</button>
                ...
                <div class="help">
    <button data-task-id="11326">
        <i aria-hidden="true" class="fa-solid fa-circle-info "></i>
    </button>
    <div class="help-container" data-task-id="11326">
        <div class="check-line">
            <div class="check-inline requirement success">
                <i aria-hidden="true" class="fa-solid fa-circle-check "></i>
                Requirement success
    ...
    <div data-role="task11327" data-position="33" id="task-num-32">
      <div class="panel panel-default task-card " id="task-11327">
  <span id="user_id" data-id="369701"></span>
...
<p>Does this page have any service workers? <code>Yes</code> or <code>No</code></p>
    ...
    <!-- Github information -->
      <div class="list-group-item">
        ...
        <ul>
          <li>GitHub repository: <code>alx-frontend</code></li>
            <li>Directory: <code>0x01-developer_tools</code></li>
            <li>File: <code>32-service_workers</code></li>
        </ul>
      </div>
...
<div>
    <button class="student_task_done btn btn-default btn-sm no" data-task-id="11327">
      <span class="no"><i aria-hidden="true" class="fa-regular fa-square "></i></span>
      <span class="yes"><i aria-hidden="true" class="fa-regular fa-square-check "></i></span>
      <span class="pending"><i aria-hidden="true" class="fa-solid fa-spinner  fa-spin-pulse"></i></span>
      Done<span class="no pending">?</span><span class="yes">!</span>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="11327" data-batch-id="90" data-toggle="modal" data-target="#task-11327-users-done-modal">
    Help
  </button>
  <div class="modal fade users-done-modal" id="task-11327-users-done-modal" data-task-id="11327" data-batch-id="90">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            <h4 class="modal-title">Learners who are done with "32. Service workers"</h4>
        </div>
        <div class="modal-body">
            <div class="list-group">
            </div>
      ...
      <button class="btn btn-default btn-sm check-your-task-11327-modal-button" data-task-id="11327" data-toggle="modal" data-target="#task-test-correction-11327-correction-modal" id="task-num-32-check-code-btn" data-gtm-custom-event-name="task_checker_modal" data-gtm-custom-event-options="{&quot;taskId&quot;:11327}">
          Check your code
      </button>
      <div class="modal fade task_correction_modal student_modal" id="task-test-correction-11327-correction-modal">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                <h4 class="modal-title">Correction of "32. Service workers"</h4>
            </div>
            <div class="modal-body">
                <div class="actions">
                    <center>
                        ...
                        <button name="button" type="submit" class="btn btn-primary correction_request_test_send" data-task-id="11327">Start a new test</button>
                        <button class="btn btn-default close-modal hidden" data-dismiss="modal" type="button">Close</button>
                ...
                <div class="help">
    <button data-task-id="11327">
        <i aria-hidden="true" class="fa-solid fa-circle-info "></i>
    </button>
    <div class="help-container" data-task-id="11327">
        <div class="check-line">
            <div class="check-inline requirement success">
                <i aria-hidden="true" class="fa-solid fa-circle-check "></i>
                Requirement success
    ...
    <div data-role="task11328" data-position="34" id="task-num-33">
      <div class="panel panel-default task-card " id="task-11328">
  <span id="user_id" data-id="369701"></span>
...
<p>The <code>security</code> panel allows you to make sure HTTS is properly implement on a webpage.</p>

<p>Which organization issued the SSL certificate for this page?</p>
    ...
    <!-- Github information -->
      <div class="list-group-item">
        ...
        <ul>
          <li>GitHub repository: <code>alx-frontend</code></li>
            <li>Directory: <code>0x01-developer_tools</code></li>
            <li>File: <code>33-ssl_cert</code></li>
        </ul>
      </div>
...
<div>
    <button class="student_task_done btn btn-default btn-sm no" data-task-id="11328">
      <span class="no"><i aria-hidden="true" class="fa-regular fa-square "></i></span>
      <span class="yes"><i aria-hidden="true" class="fa-regular fa-square-check "></i></span>
      <span class="pending"><i aria-hidden="true" class="fa-solid fa-spinner  fa-spin-pulse"></i></span>
      Done<span class="no pending">?</span><span class="yes">!</span>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="11328" data-batch-id="90" data-toggle="modal" data-target="#task-11328-users-done-modal">
    Help
  </button>
  <div class="modal fade users-done-modal" id="task-11328-users-done-modal" data-task-id="11328" data-batch-id="90">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            <h4 class="modal-title">Learners who are done with "33. Security"</h4>
        </div>
        <div class="modal-body">
            <div class="list-group">
            </div>
      ...
      <button class="btn btn-default btn-sm check-your-task-11328-modal-button" data-task-id="11328" data-toggle="modal" data-target="#task-test-correction-11328-correction-modal" id="task-num-33-check-code-btn" data-gtm-custom-event-name="task_checker_modal" data-gtm-custom-event-options="{&quot;taskId&quot;:11328}">
          Check your code
      </button>
      <div class="modal fade task_correction_modal student_modal" id="task-test-correction-11328-correction-modal">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                <h4 class="modal-title">Correction of "33. Security"</h4>
            </div>
            <div class="modal-body">
                <div class="actions">
                    <center>
                        ...
                        <button name="button" type="submit" class="btn btn-primary correction_request_test_send" data-task-id="11328">Start a new test</button>
                        <button class="btn btn-default close-modal hidden" data-dismiss="modal" type="button">Close</button>
                ...
                <div class="help">
    <button data-task-id="11328">
        <i aria-hidden="true" class="fa-solid fa-circle-info "></i>
    </button>
    <div class="help-container" data-task-id="11328">
        <div class="check-line">
            <div class="check-inline requirement success">
                <i aria-hidden="true" class="fa-solid fa-circle-check "></i>
                Requirement success
    ...
    <div data-role="task11329" data-position="35" id="task-num-34">
      <div class="panel panel-default task-card " id="task-11329">
  <span id="user_id" data-id="369701"></span>
  ...
  <div class="panel-body">
    ...
    <!-- Progress vs Score -->
      <div class="task_progress_score_bar" data-task-id="11329" data-correction-id="27622891">
        <div class="task_progress_bar" style="width: 100.0%">
          <div class="task_score_bar" style="width: 100.0%">
          </div>
        </div>
...
<p>When does the SSL certificate expire?</p>
    ...
    <!-- Github information -->
      <div class="list-group-item">
        ...
        <ul>
          <li>GitHub repository: <code>alx-frontend</code></li>
            <li>Directory: <code>0x01-developer_tools</code></li>
            <li>File: <code>34-ssl_expiration.png</code></li>
        </ul>
      </div>
...
<div>
    <button class="student_task_done btn btn-default btn-sm no" data-task-id="11329">
      <span class="no"><i aria-hidden="true" class="fa-regular fa-square "></i></span>
      <span class="yes"><i aria-hidden="true" class="fa-regular fa-square-check "></i></span>
      <span class="pending"><i aria-hidden="true" class="fa-solid fa-spinner  fa-spin-pulse"></i></span>
      Done<span class="no pending">?</span><span class="yes">!</span>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="11329" data-batch-id="90" data-toggle="modal" data-target="#task-11329-users-done-modal">
    Help
  </button>
  <div class="modal fade users-done-modal" id="task-11329-users-done-modal" data-task-id="11329" data-batch-id="90">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            <h4 class="modal-title">Learners who are done with "34. Expiration date"</h4>
        </div>
        <div class="modal-body">
            <div class="list-group">
            </div>
        ...
        <div class="fs-4">
            ...
            <div data-react-class="projects/ProjectReadyForReview" data-react-props="{&quot;csrfToken&quot;:&quot;hLS21Z76C-VKOBdjuJNRDFhDOq-ogRx5IxPMzxHrnSyc928GTdyQu0K6PJvG1Hi_Ed_ftOrD6FAlx_2vjK2HYw&quot;,&quot;firstReview&quot;:false,&quot;peerReview&quot;:{&quot;availableReviewersURI&quot;:&quot;/corrections/27622891/available_reviewers.json&quot;,&quot;canReviewPeerDirectly&quot;:true,&quot;cancelReadyForReviewURI&quot;:&quot;/corrections/27622891/cancel_ready_for_review.json&quot;,&quot;closeAt&quot;:&quot;2024-03-23T06:00:00.000+03:00&quot;,&quot;correctCorrectionURI&quot;:&quot;https://intranet.alxswe.com/corrections/27622891/correct&quot;,&quot;disabled&quot;:false,&quot;manualReviewBehavior&quot;:&quot;any_student&quot;,&quot;openAt&quot;:&quot;2024-03-20T06:00:00.000+03:00&quot;,&quot;qaReviewsURI&quot;:&quot;/corrections/to_review&quot;,&quot;readyForReviewURI&quot;:&quot;/corrections/27622891/toggle_ready_for_review.json&quot;,&quot;synchronousManualReview&quot;:false},&quot;toggled&quot;:false}" data-react-cache-id="projects/ProjectReadyForReview-0"><div class="row gap"><div class="col-md-12"><div class="text-center"><button class="btn btn-lg btn-primary">Ready for a new peer review</button></div></div></div></div>
...
<script type="text/javascript" id="" src="./Project_ 0x01. Developer tools _ ALX Africa Intranet_files/latest.js.télécharger"></script>
...
<iframe id="_hjSafeContext_37196490" title="_hjSafeContext" tabindex="-1" aria-hidden="true" src="./Project_ 0x01. Developer tools _ ALX Africa Intranet_files/saved_resource.html" style="display: none !important; width: 1px !important; height: 1px !important; opacity: 0 !important; pointer-events: none !important;"></iframe><div id="userpilotContent" key="" theme_id="0"></div>
